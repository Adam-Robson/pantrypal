...
function Page1() {
  return (
    <section className="h-1/3">
      ...
      <h2 className="text-2xl text-black font-semibold mt-4 mb-8 subpixel-antialiased">
        Welcome!
      </h2>
      <p className="mx-20 text-black subpixel-antialiased">
        Find free food options in your area so you can concentrate on your education.
      </p>
    </section>
  );
}
...
function Page2() {
  return (
    <section className="h-1/3">
      ...
      <p className="mx-20 text-black subpixel-antialiased">
        To find food pantries in your local area, please enable location sharing services.
      </p>
    </section>
  );
}
...
function Page3() {
  return (
    <section className="h-1/3">
      ...
      <h2 className="text-2xl text-black font-semibold mt-4 mb- subpixel-antialiased">
        How it Works
      </h2>
      <p className="mx-20 text-black subpixel-antialiased">
        Find your location, view pantry details, and choose the right one for your needs.
      </p>
    </section>
  );
}
